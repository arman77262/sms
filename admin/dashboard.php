...
?>
            ...
            <div class="content">
                ...
                <h1 class="text-success"><i class="fa fa-dashboard"></i> Dashbord <small>Overview</small></h1>
                <ol class="breadcrumb">
                ...
                <div class="row">
                            ...
                            <div class="panel panel-success">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9">
                                            <div class="pull-right" style="font-size: 45px">4</div>
                    ...
                    <div class="row animated fadeInUp">
                        <!-- All Studnet -->
                            ...
                            <div class="col-sm-12">
                    <h4 class="section-subtitle"><b>All New Students</b></h4>
                    <div class="panel">
